...
$select_tools = mysqli_query($koneksi, "SELECT*FROM tools");
                ...
                <tbody> 
                    ...
                    <tr> 
                        ...
                        <td>
                            ...
                            <a href="delete_tools.php?id_tools=<?php echo 
                            $tampil->id_tools;?>" class="btn btn-danger"
                            ...
                            <a href="update_form_tools.php?id_tools=<?php echo $tampil->id_tools;?>"
